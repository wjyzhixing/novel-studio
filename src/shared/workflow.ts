...
export interface WorkflowIssue { code: 'DUPLICATE_NODE' | 'UNKNOWN_NODE' | 'MISSING_NODE' | 'MISSING_PORT' | 'MISSING_INPUT' | 'PORT_TYPE_MISMATCH' | 'CYCLE'; message: string; edgeId?: string; nodeId?: string }
